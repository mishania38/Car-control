...
/*-----------------------------Топики-------------------------------------------------*/
const char startenginecom[] = "***";
const char startengine[] = "***";
const char alarmoncom[] = "***";
const char alarmon[] = "***";
const char heatenginecom[] = "***";
const char heatengine[] = "***";
const char refreshcom[] = "***";
const char batteryvolt[] = "***";
const char startperiodcom[] = "***";
const char startperiod[] = "***";
const char starterperiodcom[] = "***";
const char starterperiod[] = "***";
const char cartemp[] = "***";
const char totalerrorcount[] = "***";
const char rpminfo[] = "***";
const char rpmcom[] = "***";
